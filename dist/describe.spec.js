...
const testScl = new DOMParser().parseFromString(`<SCL
...
describe("Describe SCL elements function", () => {
    it("returns undefined with missing describe function", () => expect(describeSclElement(oneNonSCLElement)).to.be.undefined);
    it("returns undefined with missing describe function", () => expect(describeSclElement(sclElement)).to.be.undefined);
    it("return equal description with semantically equal SCL element", () => expect(JSON.stringify(describeSclElement(baseEnumType))).to.equal(JSON.stringify(describeSclElement(equalEnumType))));
    it("return different description with semantically unequal SCL element", () => expect(JSON.stringify(describeSclElement(diffEnumType))).to.not.equal(JSON.stringify(describeSclElement(equalEnumType))));
    it("returns same description with semantically equal IED's", () => expect(JSON.stringify(describeSclElement(baseIED))).to.equal(JSON.stringify(describeSclElement(equalIED))));
    it("returns different description with unequal IED elements", () => expect(JSON.stringify(describeSclElement(baseIED))).to.not.equal(JSON.stringify(describeSclElement(diffIED))));
});
