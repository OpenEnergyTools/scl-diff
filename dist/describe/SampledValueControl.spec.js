...
const missingSmpRate = scl.querySelector('SampledValueControl[name="missingSmpRate"]');
const missingNofASDU = scl.querySelector('SampledValueControl[name="missingNofASDU"]');
const missingSmpOpts = scl.querySelector('SampledValueControl[name="missingSmpOpts"]');
describe("Description for SCL schema type SampledValueControl", () => {
    it("returns undefined when referenced DataSet is undefined", () => expect(describeSampledValueControl(invalidDataSet)).to.be.undefined);
    it("returns undefined with missing referenced DataSet", () => expect(describeSampledValueControl(invalidReference)).to.be.undefined);
    it("returns undefined with missing smpRate attribute", () => expect(describeSampledValueControl(missingSmpRate)).to.be.undefined);
    it("returns undefined with missing nofASDU attribute", () => expect(describeSampledValueControl(missingNofASDU)).to.be.undefined);
    it("returns undefined with missing SmpOpts child", () => expect(describeSampledValueControl(missingSmpOpts)).to.be.undefined);
    it("returns same description with semantically equal SampledValueControl's", () => expect(JSON.stringify(describeSampledValueControl(baseSampledValueControl))).to.equal(JSON.stringify(describeSampledValueControl(equalSampledValueControl))));
    it("returns different description with unequal SampledValueControl elements", () => {
        expect(JSON.stringify(describeSampledValueControl(baseSampledValueControl))).to.not.equal(JSON.stringify(describeSampledValueControl(diffSampledValueControl)));
    });
});
//# sourceMappingURL=SampledValueControl.spec.js.map