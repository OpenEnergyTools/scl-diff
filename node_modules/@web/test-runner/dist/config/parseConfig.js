...
async function parseConfigGroups(config, cliArgs) {
    ...
    groupConfigs.push(...(await (0, collectGroupConfigs_1.collectGroupConfigs)(configPatterns)));
    return groupConfigs;
}
async function parseConfig(config, cliArgs = {}) {
    ...
    const mergedConfigs = (0, mergeConfigs_1.mergeConfigs)(defaultConfig, config, cliArgsConfig);
    ...
    if (cliArgs.puppeteer) {
        ...
        finalConfig.browsers = (0, loadLauncher_1.puppeteerLauncher)(cliArgs.browsers);
    }
        ...
        finalConfig.browsers = (0, loadLauncher_1.playwrightLauncher)(cliArgs.browsers);
    }
    else {
    ...
    if (!finalConfig.reporters) {
        finalConfig.reporters = [(0, defaultReporter_1.defaultReporter)()];
    }
    ...
    finalConfig.plugins.unshift((0, plugins_1.setViewportPlugin)(), (0, plugins_1.emulateMediaPlugin)(), (0, plugins_1.setUserAgentPlugin)(), (0, plugins_1.filePlugin)(), (0, plugins_1.sendKeysPlugin)(), (0, plugins_1.sendMousePlugin)(), (0, plugins_1.snapshotPlugin)({ updateSnapshots: !!cliArgs.updateSnapshots }));
