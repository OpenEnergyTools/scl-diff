function updateSourceRef(element, { oldSubstation, oldVoltageLevel, oldBay, newBay, }) {
...
function updateConnectivityNodes(element, { substation, voltageLevel, bayName, }) {
    ...
    cNodes.forEach((cNode) => {
        ...
        if (!oldConnectivityNode)
            return;
        updates.push(...updateTerminals(element, {
            oldConnectivityNode,
            connectivityNode,
            bayName,
        }));
...
function updateTerminals(element, { oldConnectivityNode, connectivityNode, bayName, }) {
...
//# sourceMappingURL=updateBay.js.map