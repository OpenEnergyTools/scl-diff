...
describe("Description for SCL schema type tControlWithIEDName", () => {
    it("returns undefined when referenced DataSet is undefined", () => expect(describeControlWithIEDName(invalidDataSet)).to.be.undefined);
    it("returns undefined with missing referenced DataSet", () => expect(describeControlWithIEDName(invalidReference)).to.be.undefined);
    it("returns same description with semantically equal ControlWithIEDName's", () => expect(JSON.stringify(describeControlWithIEDName(baseGSEControl))).to.equal(JSON.stringify(describeControlWithIEDName(equalGSEControl))));
    it("returns different description with unequal ControlWithIEDName elements", () => expect(JSON.stringify(describeControlWithIEDName(baseGSEControl))).to.not.equal(JSON.stringify(describeControlWithIEDName(diffGSEControl))));
});
//# sourceMappingURL=ControlWithIEDName.spec.js.map