...
import "./diff-tree.js";
class OscdDiff extends LitElement {
    constructor() {
        super(...arguments);
        this.docs = {};
    ...
    render() {
        ...
        <tr>
          <td>
            <select id="doc1">
              ${Object.keys(this.docs).map((name) => html `<option value="${name}">${name}</option>`)}
            </select>
          </td>
          <td>-></td>
          <td>
...
OscdDiff.styles = css `
  ...
  `;
export default OscdDiff;
__decorate([
    query("#doc1")
], OscdDiff.prototype, "doc1", void 0);
__decorate([
    query("#doc2")
], OscdDiff.prototype, "doc2", void 0);
__decorate([
    query("#tag")
], OscdDiff.prototype, "tag", void 0);
__decorate([
    property()
], OscdDiff.prototype, "docs", void 0);
//# sourceMappingURL=oscd-diff.js.map